...
# User credentials dictionary (in-memory database for simplicity)
user_credentials = {
    "Himesh": "12345",
    "Alice": "password1",
    "Bob": "password2",
...
def display_signin_form():
    ...
    st.text_input("Confirm Password:", key="confirm_passwd", type="password")  # New Confirm Password Field
    if st.button("Sign In"):  # Button name is "Sign In"
        ...
        if username in user_credentials:  # Check if the user exists in the system
